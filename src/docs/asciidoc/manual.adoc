...
A `GET` request lists all of the service's customers.
 ...
 TODO include::{snippets}/list-customer/response-fields.adoc[]
...
==== Request structure
 ...
 TODO include::{snippets}/create-customer/request-fields.adoc[]
...
==== Request structure
 ...
 TODO include::{snippets}/create-product/request-fields.adoc[]
