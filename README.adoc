...
image::https://img.shields.io/travis/marzelwidmer/price-service.svg?style=flat-square[travisCI]
image::https://circleci.com/gh/marzelwidmer/price-service.svg?style=shield&circle-token=:circle-token[circleCI]
